...
const archer = preload("res://assets/archers.png")
const babydragon = preload ("res://assets/baby-dragon.png")
...
const minion = preload("res://assets/minions.png")
...
const dark_barbarian = preload("res://assets/dark/barbraian dark.jpg")
